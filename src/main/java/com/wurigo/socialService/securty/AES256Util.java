package com.wurigo.socialService.securty;
...
public class AES256Util {
    private String iv;
    private Key keySpec;
    final static String secretKey =  "4920616d207769746820796f7520616c77617973";//"4920616d207769746820796f7520616c";// 
...
//        String enStr =Base64.getEncoder().encodeToString(encrypted);
    ...
    public String aesDecode(String str) throws java.io.UnsupportedEncodingException, NoSuchAlgorithmException,
        ...
        byte[] decryptByte = c.doFinal(byteStr);
