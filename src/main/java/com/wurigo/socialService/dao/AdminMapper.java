...
public interface AdminMapper {
	...
	public int adminInfoEdit(Map<String, Object> params) throws Exception;//관리자 정보 변경
	...
	public int adminUpdatePwd(Map<String,Object> params) throws Exception ; // 비밀번호 변경
